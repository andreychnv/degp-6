...
class AmountAlertsAppTest {
    ...
    void setUp() {
        ...
        purchasesTopic = testDriver.createInputTopic(AmountAlertsApp.PURCHASE_TOPIC_NAME, stringSerializer, avroSerializer);
        resultTopic = testDriver.createOutputTopic(AmountAlertsApp.RESULT_TOPIC, stringDeserializer, avroDeserializer);
    }
